"""UNet++ – self-contained port from MrGiovanni/UNetPlusPlus.
    UNet + + – self-contained 移植 from MrGiovanni / UNetPlusPlus。
...
class UNetPP(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=2, img_size=224,
        ...
        # 解码 level 1 ( X _ 01, X _ 11, X _ 21, X _ 31 ) / Decoder level 1 (X_01, X_11, X_21, X_31)
        ...
        # 解码 level 2 ( X _ 02, X _ 12, X _ 22 ) / Decoder level 2 (X_02, X_12, X_22)
        ...
        # 解码 level 3 ( X _ 03, X _ 13 ) / Decoder level 3 (X_03, X_13)
        ...
        # 解码 level 4 ( X _ 04 ) / Decoder level 4 (X_04)
