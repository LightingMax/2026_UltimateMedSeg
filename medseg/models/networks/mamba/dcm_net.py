"""DCM-Net: Dual-encoder CNN-Mamba for Medical Image Segmentation.
    DCM-Net: Dual-encoder CNN-Mamba for 医学的 图像 分割。
...
class _CrossBranchFusion(nn.Module):
    """Cross-Branch 融合 模块: 融合 CNN and Mamba 特征。
...
class DCMNet(nn.Module):
    """DCM-Net for breast ultrasound 分割。
    ...
    def __init__(self, in_channels=3, num_classes=2, img_size=224,
        ...
        # Mamba 编码器 / Mamba encoder branch
        ...
        # Cross-branch 融合 / Cross-branch fusion
    ...
    def forward(self, x):
        ...
        # 编码器 with dual branches / Encoder with dual branches
        c1 = self.cnn_enc1(x)
